...
const projects = [
    {
        ...
        category: "fronted",
        title: "project 1",
        description: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Aspernatur quae enim animi.",
...
const Work = () => {
    ...
    >
        <div className="container mx-auto">
            <div className="flex flex-col xl:flex-row xl:ga-[30px]">
                ...
                <div className="w-full xl:w-[50%]">
                    ...
                    >
                        ...
                        btnStyles="bg-accent hover:bg-accent-hover tet-primary tex-[22px] w-[44px] h-[44px]
